...
const routes: RouteConfig[] = [
  ...
  { name: 'Verify Email', path: '/verify-email', element: <VerifyEmailPage />, visible: false },
  { name: 'Forgot Password', path: '/forgot-password', element: <ForgotPasswordPage />, visible: false },
  { name: 'Reset Password', path: '/reset-password', element: <ResetPasswordPage />, visible: false },
